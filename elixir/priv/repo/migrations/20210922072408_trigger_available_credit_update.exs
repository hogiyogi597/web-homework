defmodule Homework.Repo.Migrations.TriggerAvailableCreditUpdate do
  ...
  # UPDATE: I have found a better way to implement this that won't rely on triggers but rather on GraphQL to resolve the available_credit field so this is no longer needed
